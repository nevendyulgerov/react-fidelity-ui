import { createElement, useState as useState$3, useRef as useRef$3, useEffect as useEffect$4, Fragment as Fragment$4, createContext, useContext as useContext$1 } from 'react';
...
var Button = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a));
    return (createElement("button", __assign({}, restProps, { className: componentClassName }), children));
};
Button.propTypes = {
...
var ButtonGroup = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a[className] = isNonEmptyStr(className),
        _a));
    return (createElement("div", __assign({ className: componentClassName }, restProps), children));
};
...
var CardDivider = function (_a) {
    ...
    var componentClassName = classNames((_b = {
        ...
        _b));
    return (createElement("div", __assign({}, restProps, { className: componentClassName })));
};
...
var useState = useState$3, useRef = useRef$3, useEffect = useEffect$4;
var Dropdown = function (props) {
    ...
    return (createElement("div", __assign({}, restProps, { ref: refComponent, className: componentClassName, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }),
        createElement("div", { className: "dropdown__header" }, trigger),
        createElement("div", { className: "dropdown__body", style: dropdownBodyStyle, onMouseEnter: onMouseEnterBody, onMouseLeave: onMouseLeaveBody }, children)));
};
Dropdown.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var DropdownTitle = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a[className] = isNonEmptyStr(className),
        _a));
    return (createElement("h4", { className: componentClassName }, children));
};
...
var Col = function (props) {
    ...
    return (createElement("div", __assign({}, restProps, { className: colClassName }), children));
};
Col.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var Footer = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a[className] = isNonEmptyStr(className),
        _a));
    return (createElement("footer", __assign({ role: "contentinfo" }, restProps, { className: componentClassName }), children));
};
Footer.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var useState$1 = useState$3, useEffect$1 = useEffect$4, useRef$1 = useRef$3;
var Header = function (props) {
    ...
    return (createElement(Fragment$4, null,
        sticky && (createElement("span", { ref: beforeHeaderRef, className: "invisible" })),
        createElement("header", __assign({}, restProps, { className: componentClassName }), children)));
};
Header.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var Input = function (props) {
    ...
    var renderLabel = function () { return (createElement("label", { htmlFor: restProps.id, className: labelClass }, label)); };
    ...
    return (createElement(Fragment, null,
        ...
        createElement("span", { className: inputControlClass },
            isBinaryInput && renderBeforeLabel(),
            renderInput(inputProps),
            hasIcon && (createElement("span", { className: "form-control__input-icon" }, icon)),
...
Input.defaultProps = {
    ...
    hovered: false,
    squared: false,
    renderInput: function (props) { return (createElement("input", __assign({}, props))); }
};
...
var Checkbox = function (_a) {
    ...
    return (createElement(Input, __assign({}, inputProps)));
};
Checkbox.propTypes = {
    id: propTypes_7,
    label: propTypes_14([
...
var Fragment$1 = Fragment$4;
var Textarea = function (props) { return (createElement(Input, __assign({}, props, { renderInput: function (inputProps) { return (createElement(Fragment$1, null,
        createElement("textarea", __assign({}, inputProps)))); } }))); };
Textarea.propTypes = {
    rows: propTypes_5
};
...
var Fragment$2 = Fragment$4;
var Select = function (_a) {
    var options = _a.options, restProps = __rest(_a, ["options"]);
    return (createElement(Input, __assign({}, restProps, { renderInput: function (_a) {
            var type = _a.type, restInputProps = __rest(_a, ["type"]);
            return (createElement(Fragment$2, null,
                createElement("select", __assign({}, restInputProps), options.map(function (_a) {
                    var value = _a.value, label = _a.label;
                    return (createElement("option", { key: value, value: value }, label));
                }))));
        } })));
};
Select.propTypes = {
...
var NavMenu = function (_a) {
    ...
    var componentClassName = classNames((_b = {
        ...
        _b[className] = isNonEmptyStr(className),
        _b));
    return (createElement("ul", __assign({}, restProps, { className: componentClassName }), children));
};
NavMenu.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var NavMenuItem = function (_a) {
    ...
    var componentClassName = classNames((_b = {
        ...
        _b[className] = isNonEmptyStr(className),
        _b));
    return (createElement("li", { className: componentClassName }, children));
};
...
var NavTrigger = function (_a) {
    ...
    var componentClassName = classNames((_b = {
        ...
        _b[className] = isNonEmptyStr(className),
        _b));
    return (createElement(Fragment$3, null, renderTrigger(componentClassName)));
};
...
var Sidebar = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a[className] = isNonEmptyStr(className),
        _a));
    return (createElement("div", { className: componentClassName },
        createElement("div", { className: "sidebar__body" }, children)));
};
Sidebar.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var Tabs = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a[className] = isNonEmptyStr(className),
        _a));
    return (createElement("ul", { className: componentClassName }, children));
};
Tabs.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var ThemeContext = createContext(initialContext);
...
var App = function (props) {
    ...
    return (createElement(ThemeContext.Provider, { value: {
        ...
        createElement("div", { className: "fidelity-ui-app" }, children)));
};
App.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var Badge = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a[className] = isNonEmptyStr(className),
        _a));
    return (createElement("span", __assign({}, restProps, { className: componentClassName }),
        createElement("span", { className: "badge__letter" }, children)));
};
Badge.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var Divider = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a));
    return (createElement("div", __assign({}, restProps, { className: componentClassName }),
        createElement("span", { className: "divider__text" }, children)));
};
Divider.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var Empty = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a));
    return (createElement("div", __assign({}, restProps, { className: componentClassName }),
        createElement("div", { className: "empty__wrap" },
            hasHeader && (createElement("div", { className: "empty__header" }, header)),
            createElement("div", { className: "empty__body" }, text),
            hasFooter && (createElement("div", { className: "empty__footer" }, footer)))));
};
Empty.propTypes = {
    header: propTypes_8,
    text: propTypes_14([
...
var Fillable = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a[className] = isNonEmptyStr(className),
        _a));
    return (createElement("div", __assign({}, restProps, { role: "textbox", tabIndex: 0, className: componentClassName, contentEditable: contentEditable, suppressContentEditableWarning: true, "data-placeholder": placeholder, onKeyDown: onKeyDown }), children));
};
Fillable.propTypes = {
    children: propTypes_14([
        propTypes_7,
...
var Icon = function (props) {
    ...
    return (createElement("svg", __assign({}, restProps, { className: componentClassName }),
        createElement("use", { xlinkHref: iconHref })));
};
Icon.propTypes = {
...
var useState$2 = useState$3, useEffect$3 = useEffect$4;
var Image = function (props) {
    ...
    return (createElement("span", { className: componentClassName },
        hasSpinner && !hasSpinnerFaded && (createElement("span", { className: imageSpinnerClassName }, spinner)),
        (!isError || !hasCustomError) && (createElement("img", __assign({}, restProps, { src: src, alt: alt, className: imgClassName, onLoad: onLoadSrc, onError: setImageError }))),
        isError && hasCustomError && (createElement("span", { className: "image__error" }, errorNode))));
};
Image.propTypes = {
...
var Notification = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a));
    return (createElement("div", __assign({}, restProps, { className: componentClassName }),
        hasIcon && (createElement("div", { className: "notification__icon" }, icon)),
        createElement("div", { className: "notification__message" }, children)));
};
...
var ProgressBar = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a[className] = isNonEmptyStr(className),
        _a));
    return (createElement("span", __assign({}, restProps, { role: "progressbar", className: componentClassName, style: progressInStyle })));
};
...
var ProgressLabel = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a[className] = isNonEmptyStr(className),
        _a));
    return (createElement("div", __assign({}, restProps, { className: componentClassName, style: progressLabelStyle }), label));
};
...
var Progress = function (props) {
    ...
    var componentClassName = classNames((_a = {
        ...
        _a));
    return (createElement("div", __assign({}, restProps, { className: componentClassName }),
        createElement(ProgressBar, { role: "progressbar", "aria-valuenow": formattedValue, "aria-valuemin": 0, "aria-valuemax": maxValue, value: formattedValue }),
        hasLabelSlot && (createElement(ProgressLabel, { label: label, value: formattedValue, alignment: labelAlignment }))));
};
Progress.propTypes = {
    type: typeShape,
    size: sizeShape,
...
var Table = function (props) {
    ...
    return (createElement("div", { className: tableClassName },
        hasRenderFilters && (createElement("div", { className: "table__filters" }, renderFilters())),
        hasRenderHeader && (createElement("div", { className: "table__header" }, renderHeader())),
        createElement("div", { className: "table__body" },
            createElement("table", null,
                createElement("thead", null,
                    createElement("tr", null,
                        selectable && (createElement("th", { className: "table__sort" },
                        ...
                        columns.map(function (column) {
                            ...
                            return (createElement("th", { key: "thead-col-" + name, style: tHeadColStyle },
                                createElement("div", { className: columnClassName, title: label, role: "button", onClick: function () {
                                        if (hasSort) {
                                            // @ts-ignore
                                            onSort(column, isAscSort);
                                        }
                                    } },
                                    createElement("span", { className: "table__title" }, label),
                                    createElement("span", { className: "table__sort__icon" }, renderSortIcon(sort, isSorted)))));
                        }))),
                createElement("tbody", null, items.map(function (item, rowIndex) {
                    // @ts-ignore
                    var rowId = item[itemId];
                    return (createElement("tr", { key: "tbody-row-" + rowId },
                        selectable && (createElement("td", { className: "table__checkbox" }, renderItemCheckbox(item))),
                        columns.map(function (_a, colIndex) {
                            ...
                            return (createElement("td", { key: "tbody-col-" + name, style: tbodyColStyle, onClick: function () {
                                    if (hasOnClickItem) {
                                        // @ts-ignore
...
var Tag = function (_a) {
    ...
    return (createElement("span", { className: componentClassName },
        label,
        hasOnRemove && (createElement("a", { href: "#", className: "tag__remove", onClick: function (event) {
                event.preventDefault();
